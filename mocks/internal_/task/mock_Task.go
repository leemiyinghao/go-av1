...
import (
	execution_type "github.com/leemiyinghao/go-av1/internal/models/execution_type"
...
func (_m *MockTask) GetType() execution_type.ExecutionType {
	ret := _m.Called()
	...
	var r0 execution_type.ExecutionType
	if rf, ok := ret.Get(0).(func() execution_type.ExecutionType); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(execution_type.ExecutionType)
	}
...
func (_c *MockTask_GetType_Call) Return(_a0 execution_type.ExecutionType) *MockTask_GetType_Call {
	_c.Call.Return(_a0)
	return _c
}
